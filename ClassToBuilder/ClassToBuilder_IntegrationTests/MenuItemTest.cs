...
namespace ClassToBuilder_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(BJSS.ClassToBuilder.GuidList.guidClassToBuilderCmdSet, (int)BJSS.ClassToBuilder.PkgCmdIDList.cmdidCBuilder);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "C2Builder", "BJSS.ClassToBuilder.ClassToBuilderPackage");
