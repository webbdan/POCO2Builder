...
using BJSS.ClassToBuilder;

namespace ClassToBuilder_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ClassToBuilderPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(BJSS.ClassToBuilder.GuidList.guidClassToBuilderCmdSet, (int)BJSS.ClassToBuilder.PkgCmdIDList.cmdidCBuilder);
